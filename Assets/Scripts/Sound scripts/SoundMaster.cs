...
public class SoundMaster : MonoBehaviour
{
    ...
    [Space(20), Header("Game Sounds")]
    public AudioClip Purchase;
    public AudioClip PurchaseFail;
    public AudioClip Explosion;
    public AudioClip Bonus;
    public AudioClip winclip;
    public AudioClip plinko;

    #region save keys
    [SerializeField]
    private bool saveSettings = true;
    private string saveNameSound = "soundon";
    private string saveNameMusic = "musicon";
    private string saveNameVolume = "volume";
    private string saveNameVolumeMusic = "volume_music";
    #endregion save keys
...
public int Counttowin;
    ...
    private void Start()
    {
        ...
        if (saveSettings)
        {
            SoundOn = (PlayerPrefs.GetInt(saveNameSound, 0) > 0) ? true : false;
            MusicOn = (PlayerPrefs.GetInt(saveNameMusic, 0) > 0) ? true : false;
